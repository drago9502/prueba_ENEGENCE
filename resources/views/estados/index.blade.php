...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <a onclick="cargarEstados();" class="btn btn-info mt-1">Cargar Estados</a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12 border border-primary table-responsive">
                <table style="width: 100%" class="table table-bordered" id="tablaEstados">
                    <thead>
                        <tr>
                            <th>
                                Estado
    ...
    <script src="{{ asset('js/estados/estados.js') }}?v={{ time() }}"></script>
